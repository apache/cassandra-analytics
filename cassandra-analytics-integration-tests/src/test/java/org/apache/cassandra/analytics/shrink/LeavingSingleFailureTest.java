...
class LeavingSingleFailureTest extends LeavingTestBase
{
    ...
    {
        completeTransitionsAndValidateWrites(BBHelperSingleLeavingNodeFailure.transitionalStateEnd, singleDCTestInputs(), true);
    ...
    public static class BBHelperSingleLeavingNodeFailure
    {
        ...
        public static void install(ClassLoader cl, Integer nodeNumber)
        {
            ...
            if (nodeNumber == 5)
            {
                TopologyChangeBBUtils.installLeaving(cl, BBHelperSingleLeavingNodeFailure.class);
            }
        }
