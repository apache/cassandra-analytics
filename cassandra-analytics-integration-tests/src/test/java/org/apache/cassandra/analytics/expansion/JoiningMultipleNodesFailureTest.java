...
class JoiningMultipleNodesFailureTest extends JoiningMultipleNodesTest
{
    ...
    {
        completeTransitionsAndValidateWrites(BBHelperMultipleJoiningNodesFailure.transitioningStateEnd,
                                             singleDCTestInputs(),
                                             true);
    }
    ...
    protected ClusterBuilderConfiguration testClusterConfiguration()
    {
        return clusterConfig().nodesPerDc(3)
                              ...
                              .instanceInitializer(BBHelperMultipleJoiningNodesFailure::install);
    }
