...
/**
 * Bulk writes during concurrent TCM leaves with Sidecar's CASSSIDECAR-277 token placement.
 */
class LeavingDisjointRangesTest extends LeavingMultiDCTest
{
    @Override
    ...
    protected void beforeTestStart()
    {
        ...
        assertThat(leavingNodes).extracting(instance -> instance.config().localDatacenter())
                               .containsExactlyInAnyOrder("datacenter1", "datacenter2");
    }

    @Override
    protected void beforeClusterShutdown()
    {
        completeTransitionsAndValidateWrites(BBHelper.transitioningStateEnd, multiDCTestInputs());
    }
    ...
    public static class BBHelper
    {
        ...
        public static void install(ClassLoader loader, Integer nodeNumber)
        {
            ...
            {
                TopologyChangeBBUtils.installLeaving(loader, BBHelper.class);
            }
        }
