 ...
 * and SSTable version-based bridge selection ENABLED.
 */
class BulkRoundtripBtiSSTableVersionBridgeEnabledTest extends BulkRoundtripSSTableVersionBridgeTestBase
{
    @Override
