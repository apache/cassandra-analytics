...
public abstract class ComplexTypeBuffer extends AbstractComplexTypeBuffer
{
    ...
    /**
     * Cassandra 6.0 makes {@code CollectionSerializer.pack} an instance method that derives the element count
     * from the collection. This class has no serializer instance, and {@link AbstractComplexTypeBuffer#elements()}
     * already gives the count each subclass needs, so the body of {@code pack} is inlined here unchanged.
     */
