...
public class FiveZeroCommitLog implements CommitLogInstance
{
    private static final Logger LOGGER = LoggerFactory.getLogger(FiveZeroCommitLog.class);
    private final Path directory;

    public FiveZeroCommitLog(Path folder)
    {
    ...
    {
        if (mutation instanceof FiveZeroMutation)
        {
            add(((FiveZeroMutation) mutation).mutation);
        }
    }
