...
public class FiveZeroRangeTombstoneBuilder extends RangeTombstoneBuilder<RangeTombstoneMarker>
{
    private final TableMetadata tableMetadata;
    private RangeTombstoneMarker rangeTombstoneMarker;

    public FiveZeroRangeTombstoneBuilder(TableMetadata tableMetadata)
    {
