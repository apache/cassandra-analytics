...
public class FiveZeroPartitionUpdateWrapper extends PartitionUpdateWrapper
{
    private final PartitionUpdate update;

    public FiveZeroPartitionUpdateWrapper(PartitionUpdate update, long maxTimestampMicros, @Nullable AsyncExecutor executor)
    {
