...
//    }
//
//<<<<<<<< HEAD:cassandra-bridge/src/testFixtures/java/org/apache/cassandra/spark/utils/test/TestSchema.java
//    public TestRow toTestRow(Row row, Set<String> requiredColumns, SparkSqlTypeConverter typeConverter)
//========
//    public TestRow toTestRow(org.apache.spark.sql.Row row, Set<String> requiredColumns)
//>>>>>>>> 2ce931b (CEP-44 Kafka integration for Cassandra CDC using Sidecar):cassandra-bridge/src/test/java/org/apache/cassandra/spark/utils/test/TestSchema.java
//    {
