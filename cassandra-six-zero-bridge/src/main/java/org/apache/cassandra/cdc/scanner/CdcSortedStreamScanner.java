 ...
 * <p>
 * A copy of the four-zero class, unchanged except for this comment. Cassandra 6.0 declares
 * {@code LivenessInfo} as an interface where 5.0 declared a class, so the inherited four-zero class calls
 * {@code primaryKeyLivenessInfo().isEmpty()} through {@code invokevirtual} and throws
 * {@code IncompatibleClassChangeError}. This copy recompiles that call.
 */
@NotThreadSafe
