...
{
    TypeConverter IDENTITY = (cqlType, value, isFrozen, isInnerType) -> value;
     ...
     * @param isInnerType true if type inside a complex type
     * @return equivalent value in new data format.
     */
    Object convert(CqlField.CqlType cqlType, @NotNull Object value, boolean isFrozen, boolean isInnerType);
}
