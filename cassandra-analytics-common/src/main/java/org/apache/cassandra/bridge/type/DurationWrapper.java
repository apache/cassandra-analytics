...
/**
 * Wrapper around Spark {@code CalendarInterval} to prevent declaring Spark
 * dependency in Cassandra type modules.
 */
public class DurationWrapper
{
    ...
    public DurationWrapper(int months, int days, long nanoseconds)
    {
        this.months = months;
        this.days = days;
