 ...
 *
 * <p>Jvm-dtest relies on classloader isolation to run multiple cassandra instances in the same JVM, this makes it
 ...
 *
 * <p>This class is copied from the Apache Cassandra codebase
 */
...
public @interface Shared
{
    ...
    {
        NONE,
        INTERFACES /*(and enums and exceptions) */,
        ALL
    }
