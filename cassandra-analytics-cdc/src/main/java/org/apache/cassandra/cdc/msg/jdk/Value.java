...
public class Value extends AbstractValue implements MessageConverter<Column>
{
    Value(String keyspace,
          String columnName,
          String columnType,
          ByteBuffer value)
    {
    ...
    public Column toCdcMessage()
    {
        return new Column(columnName, CassandraTypesImplementation.INSTANCE.parseType(columnType), getValue());
    }
}
