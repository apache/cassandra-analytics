...
public class RangeTombstone extends AbstractRangeTombstone<Value> implements MessageConverter<RangeTombstoneMsg>
{
    RangeTombstone(@NotNull List<Value> startBound, boolean startInclusive,
                   @NotNull List<Value> endBound, boolean endInclusive)
    {
        super(startBound, startInclusive, endBound, endInclusive);
    }

    public RangeTombstoneMsg toCdcMessage()
    {
        return new RangeTombstoneMsg(this);
    }
}
