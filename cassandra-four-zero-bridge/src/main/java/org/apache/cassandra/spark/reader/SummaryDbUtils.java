 ...
 * <br>
 * This class is Cassandra version agnostic; it is not duplicated in the other bridges
 */
public final class SummaryDbUtils
{
    ...
    public static IndexSummaryComponent readSummary(@NotNull TableMetadata metadata, @NotNull SSTable ssTable) throws IOException
    {
        return readSummary(ssTable, metadata.partitioner, metadata.params.minIndexInterval, metadata.params.maxIndexInterval);
    }

    @Nullable
    public static IndexSummaryComponent readSummary(@NotNull SSTable sstable,
                                                    ...
                                                    int maxIndexInterval) throws IOException
    {
        ...
        {
            return IndexSummaryComponent.readSummary(in, partitioner, minIndexInterval, maxIndexInterval);
        }
    }
